...
Facilitators outside Australia are encouraged to contribute jurisdiction-specific adaptations to the project's [adaptations directory](../../adaptations/) in the GitHub repository, where contributed files are available for others to reuse.
...
- That the participant may withdraw from the project at any time, and may request removal of their images from the physical exhibition at any time up to and including Week 8
- That after Week 8, selected images are uploaded to the project's online gallery at the project website, where they remain publicly accessible indefinitely unless the participant requests removal
- That requesting removal from the online gallery after the project closes is possible by contacting the project coordinator, but that the coordinator cannot control copies of images that have already been shared or downloaded by third parties
- That images displayed in the public exhibition may be photographed by members of the community and shared on social media before the online gallery upload - this cannot be controlled once images are publicly displayed, and participants should be aware of this before selecting images for exhibition
- Contact details for the facilitator and for the project GitHub Issues page 
- The WordPress site is the public-facing home of the project
